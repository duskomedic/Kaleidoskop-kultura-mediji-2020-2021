---
title: "Pod lupom: Kultura u medijima – Šta je finansirano konkursima iz oblasti kulture u 2021. i 2022. godini?"
subtitle: "Kulturni centar Kaleidoskop"
author: "Autori: Duško Medić i Gordana Tadić-Novaković<br>"
date: "Maj 2023. godine<br>"
...
Projektkultura <- filter(Projektkultura, ORGAN == 'Ministarstvo kulture')
...
U nastavku donosimo detaljnu statističku analizu konkursa za sufinansiranje projekata proizvodnje medijskih sadržaja koji promovišu i afirmišu teme iz oblasti kulture u 2021. i 2022. godini Ministarstva kulture i informisanja.<br>


## ANALIZA MEDIJSKIH PROJEKATA KONKURSA ZA SUFINANSIRANJE PROJEKATA PROIZVODNJE MEDIJSKIH SADRŽAJA KOJI PROMOVIŠU I AFIRMIŠU TEME IZ OBLASTI KULTURE U 2021. I 2022. GODINI - MINISTARSTVO KULTURE I INFORMISANJA
...
ggplot(dataLINE1) + 
  ...
  ggtitle("Medijski projekti u oblasti kulture (2015 - jun 2022); Ministarstvo kulture") +
...
Prosečna vrednost medijskih projekata, sufinansiranim javnim konkursima za sufinansiranje projekata proizvodnje medijskih sadržaja koji promovišu i afirmišu teme iz oblasti kulture u 2021. i 2022. godini, iznosi <b>`r prosecnavrednostdinari` dinara</b> ili <b>`r prosecnavrednostevri` evra</b>. S obzirom da prosečnu vrednost čini i velik broj onih projekata koji daleko prevazilazi srednju vrednost, o samoj vrednosti projekta u posmatranom periodu više govori medijana ili srednja vrednost projekata koja deli sve vrednosti projekata na dva dela iznad i ispod vrednosti medijane, koja je u posmatranom periodu iznosi <b>`r medijanavrednostidinari` dinara</b> ili <b>`r medijanavrednostievri` evra</b>.
<br>
...
ggplot(dataLINE2) + 
  ...
  ggtitle("Broj medijskih projekata po godinama (2021 - 2022); Ministarstvo kulture") +
...
<b>Ukupno (`r brojpr`) medijskih projekata</b> namenjenih proizvodnji medijskih sadržaja koji promovišu i afirmišu teme iz oblasti kulture, realizavalo je, u 2021. godini i 2022. godini, <b>`r brojpodnosilaca` različitih podnosioca projekata</b>. 
<br>
<br>
...
datatable(TopPODNOSILAC, caption = 'Tabela 2: Ukupan broj relevantnih projekata i njihova suma u evrima prema podnosiocu projekta (2021-2022)', options = list(pageLength = 5))
...
<b>Ukupno (`r brojpr`) medijskih projekata</b> namenjenih proizvodnji medijskih sadržaja koji promovišu i afirmišu teme iz oblasti kulture u 2021. i 2022. godini, realizavalo je, <b>`r brojmedija-2` različitih medija</b> dok su ostali medijski projekti nastali u različitim produkcijama.
<br>
<br>
...
```{r echo=FALSE}
datatable(TopPODNOSILAC, caption = 'Tabela 3: Suma odobrenih sredstava i broj projekata po medijima - 2021-2022.', options = list(pageLength = 5))
...
```
Ukupno <b>`r Brojjedinstvenihprodukcija` produkcijskih kuća</b> je sprovodilo medijske projekte čiji je cilj bio proizvodnja medijskih sadržaja koji promovišu i afirmišu teme iz oblasti kulture. Iako smo nedostajuće podatke iz rešenja medijskih konkursa dodatno proveravali u "Registru medija", ovde treba voditi računa da u slučajevima kada u rešenjima nije navedeno ime medija i kada nije bilo podataka u registru, podnosioce projekata koje imaju registrovane medije, navodili smo kao produkciju.
<br>
<br>
...
```{r echo=FALSE}
datatable(TopPODNOSILAC, caption = 'Tabela 4: Ukupan broj produkcija i suma u evrima koja im je dodeljena u periodu 2021-2022. godine', options = list(pageLength = 5))
...
<br>
Pogrešno smo pretpostavili da će projekti kodirani kao projekti AKTUELNE KULTURNE PRODUKCIJE <b>Ministarstvo kulture i informisanja</b> imati najviše udela u kodiranim oblastima, s obzirom na prirodu medija i informisanja, međutim, to nije slučaj, svega <b>`r TopAKP` projekata</b> je kodirano kao AKTUELNA KULTURNA PRODUKCIJA, svega `r TopAKP*100/sumaprojekataoblast` odsto projekata. Tj ukupno <b>`r TopAKPevri` evra</b>.
<br>
Najviše sredstava <b>Ministarstvo kulture i informisanja</b> "investiralo" je u <b>oblast `r Toppodob`</b>‚ ukupno <b> `r Topevriob` evra </b> za <b> `r Toppodobbroj` projekata</b>.
<br>
<br>

```{r echo=FALSE}
# datatable(OBLASTI, caption = 'Tabela 5: Ukupan broj medijskih projekata namenjenih kulturi po oblastima i njihova suma u evrima koja im je dodeljena u periodu od 2021-2022. godine.', options = list(pageLength = 22))
# 
# 
# 
# # Plot
...
#Brojpodoblastcisto$EVRI <- format(novac, big.mark=',', digits = 0, nsmall=0, scientific = FALSE)
...
Ministarstvo kulture i informisanja za oblast AKTUELNA KULTURNA PRODUKCIJA odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu od 2021-2022. godine.
<br>
<br>
...
<br>
<br>
Ministarstvo kulture i informisanja za oblast AKTUELNA KULTURNA PRODUKCIJA najviše je odobrilo sredstava za <b>podoblast `r JEZICI1[1,1]`</b>, ukupno <b>`r JEZICI1[1,3]` evra</b> za <b>`r JEZICI1[1,2]` projekata</b>.
<br>
<br>
...
data10 <- data8 %>% replace(data8 == "NULL", NA)


# Calculate percentages
pct <- round(100*data10$BROJ.PROJEKATA/sum(data10$BROJ.PROJEKATA))
# Draw oie chart
pie(data10$BROJ.PROJEKATA,
    labels = paste(data10$Podoblast, sep = " ", pct, "%"), 
    col = brewer.pal(length(data10$Podoblast), "Set1"),
    border="white",
    main = "Aktuelna kulturna produkcija - Broj projekata po podoblastima")
...
Ministarstvo kulture i informisanja za oblast MANIFESTACIJE odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu 2021-2022. godine.
<br>
<br>
...
<br>
<br>
Ministarstvo kulture i informisanja za oblast MANIFESTACIJE najviše je odobrilo sredstava za <b>podoblast `r JEZICI2[1,1]`</b>, ukupno <b>`r JEZICI2[1,3]` evra</b> za <b>`r JEZICI2[1,2]` projekata</b>.
<br>
<br>
...
pie(data10$BROJ.PROJEKATA,
    ...
    col = brewer.pal(length(data10$Podoblast), "Set1"),
    border="white",
    main = "Manifestacije - Broj projekata po podoblastima")
...
Ministarstvo kulture i informisanja za oblast KULTURNA BAŠTINA odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu 2021-2022. godine.
<br>
<br>
...
<br>
<br>
Ministarstvo kulture i informisanja za oblast KULTURNA BAŠTINA najviše je odobrilo sredstava za <b>podoblast `r JEZICI3[1,1]`</b>, ukupno <b>`r JEZICI3[1,3]` evra</b> za <b>`r JEZICI3[1,2]` projekata</b>.
<br>
<br>
...
pie(data10$BROJ.PROJEKATA,
    ...
    col = brewer.pal(length(data10$Podoblast), "Set1"),
    border="white",
    main = "Kulturna baština - Broj projekata po podoblastima")
...
```
Ministarstvo kulture i informisanja za oblast OBRAZOVANJE odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu 2021-2022. godine.
<br>
<br>
...
<br>
<br>
Ministarstvo kulture i informisanja za oblast OBRAZOVANJE najviše je odobrilo sredstava za <b>podoblast `r JEZICI4[1,1]`</b>, ukupno <b>`r JEZICI4[1,3]` evra</b> za <b>`r JEZICI4[1,2]` projekata</b>.
<br>
<br>
...
pie(data10$BROJ.PROJEKATA,
    ...
    col = brewer.pal(length(data10$Podoblast), "Set1"),
    border="white",
    main = "Obrazovanje - Broj projekata po podoblastima")
...
```
Ministarstvo kulture i informisanja za oblast DRUŠTVO odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu 2021-2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
<br>
<br>
Ministarstvo kulture i informisanja za oblast DRUŠTVO najviše je odobrilo sredstava za <b>podoblast `r JEZICI5[1,1]`</b>, ukupno <b>`r JEZICI5[1,3]` evra</b> za <b>`r JEZICI5[1,2]` projekata</b>.
<br>
<br>
...
USPersonalExpenditure <- data.frame("Categorie"=rownames(USPersonalExpenditure), USPersonalExpenditure)
data6 <- USPersonalExpenditure[,c('Podoblast', 'BROJ.PROJEKATA', 'EVRI')]


data7 <- data6 %>% replace(data6 == "NULL", NA)


# Calculate percentages
pct <- round(100*data7$BROJ.PROJEKATA/sum(data7$BROJ.PROJEKATA))
# Draw oie chart
pie(data8$BROJ.PROJEKATA,
    labels = paste(data7$Podoblast, sep = " ", pct, "%"), 
    col = brewer.pal(length(data7$Podoblast), "Set1"),
    border="white",
    radius = 1,
    main = "Društvo - Broj projekata po podoblastima")

# legend("topright", 
#        c(data7$Podoblast), 
#        cex = 0.8, 
#        fill = c(brewer.pal(length(data7$Podoblast), "Set1")))
...
Ministarstvo kulture i informisanja za oblast FILMSKO STVARALAŠTVO odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu 2021-2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
USPersonalExpenditure <- data.frame("Categorie"=rownames(USPersonalExpenditure), USPersonalExpenditure)
data7 <- USPersonalExpenditure[,c('Podoblast', 'BROJ.PROJEKATA', 'EVRI')]


data8 <- data7 %>% replace(data7 == "NULL", NA)


# Calculate percentages
pct <- round(100*data8$BROJ.PROJEKATA/sum(data8$BROJ.PROJEKATA))
# Draw oie chart
pie(data8$BROJ.PROJEKATA,
    labels = paste(data8$Podoblast, sep = " ", pct, "%"), 
    col = brewer.pal(length(data8$Podoblast), "Set1"),
    border="white",
    main = "Filmsko stvaralaštvo - Broj projekata po podoblastima")

legend("topright", 
       c(data8$Podoblast), 
       cex = 0.8, 
       fill = c(brewer.pal(length(data8$Podoblast), "Set1")))
...
Ministarstvo kulture i informisanja za oblast MULTIKULTURALNOST odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu 2021-2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra. 
<br>
...
pie(data10$BROJ.PROJEKATA,
    ...
    col = brewer.pal(length(data10$Podoblast), "Set1"),
    border="white",
    main = "Multikulturalnost - Broj projekata po podoblastima")

legend("topright", 
       c(data10$Podoblast), 
       cex = 0.8, 
       fill = c(brewer.pal(length(data10$Podoblast), "Set1")))
...
Ministarstvo kulture i informisanja za oblast VIZEULNO STVARALAŠTVO odobrilo je ukupno <b>`r paste0("", formatC(as.numeric(novac), format="f", digits=0, big.mark=","))` evra</b> za <b>`r projekti[1,2]` projekata</b>, što je <b>`r round(novac*100/ukupnasuma, digit=2)` odsto</b> od ukupne odobrene sume za projekte čiji je cilj bio poboljšanje informisanja građana o kulturi, u periodu 2021-2022. godine.
<br>
<br>
U ovoj oblasti najviše sredstava odobreni su projektima sledećih naziva: <br> •  <b>`r paste(Imena, SUMAMedija,  sep = " - ", collapse = " evra <br> • ")`</b> evra.
<br>
...
# Calculate percentages
pct <- round(100*data9$BROJ.PROJEKATA/sum(data9$BROJ.PROJEKATA))
# Draw oie chart
pie(data9$BROJ.PROJEKATA,
    labels = paste(data9$Podoblast, sep = " ", pct, "%"), 
    col = brewer.pal(length(data9$Podoblast), "Set1"),
    border="white",
    main = "Vizuelno stvaralaštvo - Broj projekata po podoblastima")

legend("topright", 
       c(data9$Podoblast), 
       cex = 0.8, 
       fill = c(brewer.pal(length(data9$Podoblast), "Set1")))
...
datatable(brojprojekataTabela, caption = 'Tabela 14: Tabela svih podržanih medijskih projekata u kulturi u periodu 2021-2022. godine.', options = list(pageLength = 5, initComplete = JS(
...
datatable(brojprojekataTabela, caption = 'Tabela 14: Tabela svih podržanih medijskih projekata u kulturi u periodu 2021-2022. godine.', options = list(pageLength = 5), filter = c("top"))
